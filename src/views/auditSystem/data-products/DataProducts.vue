...
import { getProductsAudit,getProductsAuditCount,renewProductsAudit } from '@/api/data_products'
...
getProductsAuditCount().then(res => {
    if (res.status == 200) {
...
getProductsAudit(page.current_page).then(res => {
    if (res.status == 200) {
        if (res.data.data != null) {
