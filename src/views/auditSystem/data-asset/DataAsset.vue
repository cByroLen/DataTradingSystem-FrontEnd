        ...
        <el-container>
            ...
            <el-main class="DAR-main-container">
                <el-table :data="OwnerDataAsset.arr" style="width: 100%" border>
                    ...
                    <el-table-column prop="renew_time" label="数据更新时间" />
...
import { getAssetAuditCount,getAssetAudit } from '@/api/data_asset'
...
getAssetAudit(page.current_page).then(res => {
    if (res.status == 200) {
        if (res.data.data != null) {
