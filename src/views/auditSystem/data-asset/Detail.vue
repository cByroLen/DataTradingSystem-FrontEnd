                    ...
                    <el-form :inline="true" class="form" :model="DataAssetRegForm" ref="DataAssetRegFormRef">
                        ...
                        <el-card shadow="never">
                            <el-form-item label="溯源证明文件" class="e3">
                                <el-upload ref="TCDRef" show-file-list="true" :auto-upload="true" drag
                                    action="http://localhost:5173/api/da/TCD" :limit="1" :on-success="TCDpathRes"
                                    v-model:file-list="TCDFileList" style="width: 150%;">
                            ...
                            <el-form-item label="质量评估报告" class="e3">
                                <el-upload ref="QARRef" show-file-list="true" :auto-upload="true" drag
                                    action="http://localhost:5173/api/da/QAR" :limit="1" :on-success="QARpathRes"
                                    v-model:file-list="QARFileList" style="width: 150%;">
                                    <el-icon class="el-icon--upload"><upload-filled /></el-icon>
                                    <div class="el-upload__text">
                                        拖动文件上传 或 <em>点击上传</em>
                                    </div>
                        ...
                        <el-form-item>
                            <el-button type="primary" @click="dialogFormVisible = true"
                                class="submit-button">审核结果</el-button>
...
import { ElMessage, type FormInstance, type UploadFile, type UploadFiles, type UploadInstance, type UploadProps, type UploadUserFile } from 'element-plus'
import { UploadFilled } from '@element-plus/icons-vue'
import { RenewDA,renewAssetAudit } from '@/api/data_asset'
import { useRoute, useRouter } from 'vue-router'

const FlaskGobalPath = 'file://laptop-ccr9qmkc/'
...
const RenewAudit = (formEL: FormInstance | undefined) => {
    ...
    formEL.validate((valid) => {
        if (valid) {
            ...
            renewAssetAudit(renewAuditForm).then(res => {
                if (res.data.code == 200) {
                    ElMessage(res.data.msg)
                    router.push('/as/data-asset')
                }
                else {
