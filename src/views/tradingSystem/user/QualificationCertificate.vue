            ...
            <el-scrollbar height="859px">
                <div class="QCform-container">
                    <el-form :model="QCform" label-width="420px" class="form" ref="QCformRef">
                        ...
                        <el-form-item>
                            <el-button type="primary" @click="onSubmit(QCformRef)">提交</el-button>
                        </el-form-item>
                    </el-form>
                </div>
            </el-scrollbar>
...
const QCform = reactive({
    account_id:ID,
    c_unified_social_credit_code: '',//统一社会信用代码
    c_name: "",//企业名称
    c_type: "",//企业类型
    c_scrope: "",//企业业务范围
    //营业执照
